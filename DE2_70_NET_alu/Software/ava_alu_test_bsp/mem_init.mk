...
.PHONY: cfi_flash
cfi_flash: check_elf_exists $(meminit_mkdirs_deps) $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym $(MEM_0).flash

# Memory: epcs_flash_controller
MEM_1 := epcs_flash_controller_boot_rom
...
epcs_flash_controller: check_elf_exists $(meminit_mkdirs_deps) $(HDL_SIM_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym $(MEM_1).flash
...
.PHONY: sdram_u1
sdram_u1: check_elf_exists $(meminit_mkdirs_deps) $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
